...
def kimi(
    ...
    # Customization
    agent: Annotated[
        Literal["default", "okabe", "agent-optimizer", "video-auto-eval", "video-evaluator"] | None,
        typer.Option(
            "--agent",
    ...
    if agent is not None:
        match agent:
            ...
            case "agent-optimizer":
                agent_file = AGENT_OPTIMIZER_AGENT_FILE
            case "video-auto-eval":
